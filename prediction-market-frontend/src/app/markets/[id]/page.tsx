            ...
            <div className="sticky top-6 bg-[#1A1A1A] rounded-xl p-6 border border-[#2A2A2A]">
              ...
              <div className="flex gap-2 mb-6 bg-[#0A0A0A] rounded-lg p-1">
                <button
                  ...
                  className={`flex-1 py-2 px-4 rounded-lg font-medium transition-all duration-150 cursor-pointer ${
                    activeTab === "buy"
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <button
                  ...
                  className={`py-3 px-4 rounded-lg font-bold transition-all duration-150 cursor-pointer ${
                    selectedOption === 0
